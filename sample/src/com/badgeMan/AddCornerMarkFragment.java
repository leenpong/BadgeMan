...
public class AddCornerMarkFragment extends Fragment
{
	...
	private Resources r;
	private ImageView promptImageView;//引导图片（点击我看一下）
	...
	private SecondFragment secondfragment = new SecondFragment();//主界面fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
		...
		savaButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getActivity(), "保存成功"+DrawCornerMark.imagefile, Toast.LENGTH_SHORT).show();
			}
		});
			...
			WindowManager wm = getActivity().getWindowManager();
		     ...
		     if(position<2){
		    	//将它三等份
		    	 ...
		    	 View view = LayoutInflater.from(getActivity()).inflate(R.layout.gridviewotheritem, null); //mContext指的是调用的Activtt
